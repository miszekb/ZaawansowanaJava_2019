...
public class PastPaymentRepositoryTest {
    ...
    public void setUp() {
        ...
        pastPayment = new PastPayment(1,"pszne obiad",21.37f,(short)2, "bardzo pszne", date);
        pastPayment2 = new PastPayment(2,"pszne obiad2",14.10f,(short)1, "bardzo pszne2", date2);
